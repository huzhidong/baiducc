...
#ifndef _NODE_BROADCAST_H
#define _NODE_BROADCAST_H
...
class NodeBroadcast : public NodeResource {
public:
    NodeBroadcast(const uint32_t id, const string& name,
                  const string& type, const string& desc, const key_map_t& keymap);
    virtual ~NodeBroadcast(void);
...
private:
    ...
    const static char* _s_param_file;        ///<
