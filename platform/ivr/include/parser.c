 ...
 * 
 * 使用 lemon parser.y生成代码
 * 编译过程中，403行提示，未使用的变量result，直接注释，其他的未修改
 *  
 **/
#include <stdio.h>
#line 7 "parser.y"
...
#endif
#define ParseARG_SDECL  result_t *result ;
#define ParseARG_PDECL , result_t *result 
#define ParseARG_FETCH  result_t *result  = yypParser->result 
...
static const YYACTIONTYPE yy_action[] = {
 ...
 /*    20 */     1,    6,   20,   34,   11,   35,   35,   13,   35,   12,
 /*    30 */    19,   18,   17,   16,   15,   14,   10,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,    1,    2,    3,    4,    5,    6,    1,    2,    3,
 /*    10 */     4,    5,    6,    1,    2,    9,    3,    4,    5,    6,
 /*    20 */     8,    6,   10,   12,   13,   14,   14,   13,   14,   13,
 /*    30 */    13,   13,   13,   13,   13,   13,   13,
};
...
static const signed char yy_reduce_ofst[] = {
 /*     0 */    11,   23,   22,   21,   20,   19,   18,   17,   16,   14,
};
...
#line 70 "parser.y"
{
  ...
  result->check_val(yygotominor.yy0);
}
#line 722 "parser.c"
        break;
